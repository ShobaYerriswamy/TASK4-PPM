                                    ...
                                    case "8":
                                        ...
                                        try
                                        {
                                            ...
                                            if (PM.Exist(idforDeleting))
                                            {
                                                for (int i=0; i<PM.projects.Count; i++)
                                                {
                                                    for (int j=0; j<PM.projects[i].EmployeeListfromEmployeeManager.Count; j++)
                                                    {
                                                        if (PM.projects[i].id == idforDeleting)
                                                        {
                                                            PM.EmployeeFromProject(idforDeleting, PM.projects[i].EmployeeListfromEmployeeManager[j]);
                                                        }
                                                    }
                                                
                                                    if (PM.projects[i].id == idforDeleting)
                                                    {
                                                        PM.DeleteProject(idforDeleting, PM.projects[i]);
                                                        Console.WriteLine("Successfully Deleted");
                                                    }
                                                }
                                            }
                                    ...
                                    case "4":
                                        try
                                        {
                                            ...
                                            for (int i=0; i< EM.employeeList.Count; i++)
                                            {
                                                ...
                                                {
                                                    for (int j=0; j<PM.projects.Count; j++)
                                                    {
                                                        if (PM.projects.Count !=0 && PM.projects[j].EmployeeListfromEmployeeManager.Count !=0)
                                                        {
                                                            for (int k=0; k<PM.projects[j].EmployeeListfromEmployeeManager.Count; k++)
                                                            {
                                                                if (PM.projects[j].EmployeeListfromEmployeeManager[k].employeeID == idforDeleting)
                                                                {
                                                                    PM.projects[j].EmployeeListfromEmployeeManager.Remove(PM.projects[j].EmployeeListfromEmployeeManager[k]);
                                                                }
                                                            }
                                                        }
                                                    }
